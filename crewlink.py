...
if not SIMULATION_MODE:
    ...
    if not SERIAL_PORT:
        ...
        try:
            ...
            ser.write(b'la\r')
            time.sleep(3.0) # Wait for the module to spit out all the anchors
...
# --- GEOFENCE (Meters) ---
BOAT_COORDS = [
    (0.0, 2.0),     (0.32, 1.84),     (0.64, 1.52),     
    (0.84, 1.0),     (1.0, 0.4),     (1.0, -1.2),    
    (0.84, -1.92),    (0.8, -2.0),    (0.4, -2.0),    
    (0.4, -1.92),    (-0.4, -1.92),   (-0.4, -2.0),   
    (-0.8, -2.0),   (-0.84, -1.92),   (-1.0, -1.2),   
    (-1.0, 0.4),    (-0.84, 1.0),    (-0.64, 1.52),    
    (-0.32, 1.84),    
]
CABIN_COORDS = [(0.0, 0.88), (0.6, 0.6), (0.6, -1.0), (-0.6, -1.0), (-0.6, 0.6)]
...
while running:
    ...
    if SIMULATION_MODE:
        ...
        lines = [f"Pos(0) : est[{t0_x}, {t0_y}, 1.0, 100]", f"Pos(1) : est[{center_x-0.5}, {center_y+0.5}, 1.0, 100]"]
